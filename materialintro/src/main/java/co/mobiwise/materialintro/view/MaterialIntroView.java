...
public class MaterialIntroView extends RelativeLayout {
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        boolean isTouchOnFocus = true;
        //= targetShape.isTouchOnFocus(xT, yT);
     ...
     * animation
     */
    private void setImageViewIcon(int id) {
    ...
    private void setDotViewLayout() {
        ...
        handler.post(new Runnable() {
            ...
            public void run() {
                ...
                dotViewLayoutParams.height = targetView.getView().getHeight()+Utils.dpToPx(20);
                dotViewLayoutParams.width = targetView.getView().getWidth()+Utils.dpToPx(20);
    ...
    private void setShapeType(ShapeType shape) {
        ...
        if(shapeType == ShapeType.CIRCLE)
            dotView.setImageResource(R.drawable.rond_corner_dot);
        else
            dotView.setImageResource(R.drawable.round_corner_blue_fade);
    }
    ...
    public static class Builder {
        ...
        public Builder setImageView(int id) {
            materialIntroView.setImageViewIcon(id);
            return this;
        }
