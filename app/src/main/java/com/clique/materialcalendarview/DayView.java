...
class DayView extends CheckedTextView {
    ...
    private void setEnabled() {
        ...
        boolean showOtherMonths = com.clique.materialcalendarview.MaterialCalendarView.showOtherMonths(showOtherDates);
        boolean showOutOfRange = com.clique.materialcalendarview.MaterialCalendarView.showOutOfRange(showOtherDates) || showOtherMonths;
        boolean showDecoratedDisabled = com.clique.materialcalendarview.MaterialCalendarView.showDecoratedDisabled(showOtherDates);
