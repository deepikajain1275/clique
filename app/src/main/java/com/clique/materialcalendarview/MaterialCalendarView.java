package com.clique.materialcalendarview;
...
import com.clique.R;
import com.clique.decorators.HighlightWeekendsDecorator;
import com.clique.decorators.MySelectorDecorator;
import com.clique.decorators.OneDayDecorator;
import com.clique.materialcalendarview.format.ArrayWeekDayFormatter;
import com.clique.materialcalendarview.format.DateFormatTitleFormatter;
import com.clique.materialcalendarview.format.DayFormatter;
import com.clique.materialcalendarview.format.MonthArrayTitleFormatter;
import com.clique.materialcalendarview.format.TitleFormatter;
import com.clique.materialcalendarview.format.WeekDayFormatter;
...
public class MaterialCalendarView extends ViewGroup {
     ...
     *
     * @param mySelectorDecorator
     * @param highlightWeekendsDecorator
     * @param oneDayDecorator
     * @param decorators                 decorators to add
     */
    public void addDecorators(MySelectorDecorator mySelectorDecorator, HighlightWeekendsDecorator highlightWeekendsDecorator, OneDayDecorator oneDayDecorator, DayViewDecorator... decorators) {
    ...
    protected void dispatchOnDateSelected(final CalendarDay day, final boolean selected) {
        ...
        if (l != null) {
            if (day.getDate().before(CalendarDay.today().getDate())) {
                adapter.clearSelections();
                l.onDateSelected(MaterialCalendarView.this, day, false);
            } else
