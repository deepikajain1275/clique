...
public class FancyCoverFlow extends Gallery {
    ...
    private float reflectionRatio = 0.0f;
    ...
    protected boolean getChildStaticTransformation(View child, Transformation t) {
        ...
        if (this.unselectedAlpha != 1) {
            ...
            float alph = 0;
            Log.i("", (0 - 1) * Math.abs(effectsAmount) + 1 + "");
            if (((0 - 1) * Math.abs(effectsAmount) + 1) < 1)

                alph = 0;
            else
                alph = (0 - 1) * Math.abs(effectsAmount) + 1;
//            tv_info.setAlpha(alph);
//            tv_crush.setAlpha(alph);
//            tv_name.setAlpha(alph);
        }
